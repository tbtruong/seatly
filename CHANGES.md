...
- Updated the API client and modal to surface structured conflict errors, so users immediately know which week failed when the backend rejects part of a series.s
